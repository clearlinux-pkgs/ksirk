...
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/ksirk-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/ksirk-19.12.1.tar.xz.sig
...
%prep
%setup -q -n ksirk-19.12.1
cd %{_builddir}/ksirk-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578680785
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksirk-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/ksirk/0b184ad51ba2a79e85d2288d5fcf8a1ea0481ea4
cp %{_builddir}/ksirk-19.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/ksirk/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/ksirk-19.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/ksirk/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/ksirk-19.12.1/ksirk/iris/COPYING %{buildroot}/usr/share/package-licenses/ksirk/caeb68c46fa36651acf592771d09de7937926bb3
pushd clr-build
%make_install
popd
%find_lang ksirk
