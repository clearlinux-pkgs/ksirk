...
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/ksirk-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/ksirk-24.08.2.tar.xz.sig
...
%setup -q -n ksirk-24.08.2
cd %{_builddir}/ksirk-24.08.2
pushd ..
cp -a ksirk-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728583903
mkdir -p clr-build
pushd clr-build
